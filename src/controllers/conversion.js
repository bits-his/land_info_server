    ...
    db.sequelize
        .query(
            `INSERT INTO lis.conversion(
                 applicant_full_name, age, occupation, nationality, state_of_origin, home_domicile, add_in_nig, phone, name_add_of_lcl_rep, suff_desc, customary_title, purp_for_land_req, value_of_impr_offered_and_time_for_erection, applicants_src_of_financing_impr_offered, len_of_time_req, date, signature, file_no)
